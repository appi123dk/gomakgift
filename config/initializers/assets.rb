...
Rails.application.config.assets.precompile += %w( knockturns.js )
Rails.application.config.assets.precompile += %w( knockturns.css )
Rails.application.config.assets.precompile += %w( admin_areas.js )
Rails.application.config.assets.precompile += %w( admin_areas.css )
